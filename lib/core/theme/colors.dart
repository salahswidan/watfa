...
class ColorsManagers {
  ...
  static const Color pink = Color(0xffF7E8FF);
  static const Color regalia = Color(0xff5C2C80);
  static const Color lightGreen = Color(0xff54D468);
